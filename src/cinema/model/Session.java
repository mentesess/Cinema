...
public class Session {
	...
	public boolean addTicket(Ticket newTicket){
		if(tickets.containsKey(newTicket.getRows()* this.getHall().getCols()+newTicket.getCols())){
			return false;
		}
		else{
		tickets.put(newTicket.getRows()* this.getHall().getCols()+newTicket.getCols(), newTicket);
		counter++;
		return true;
		}
	}
	...
	public String toString() {
		return "Session [hall=" + hall + ", hour=" + hour + ", movieName="
				+ movieName + ", tickets=" + tickets + ", Tickets count=" + counter
				+ "]";
	}
